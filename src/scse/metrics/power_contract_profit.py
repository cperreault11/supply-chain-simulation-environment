...
class ProfitCalculations():
    ...
    def compute_reward(self, state, action):
        if action['type'] == 'advance_time':
            ...
            true_demand_at_price = state['demand_at_price']['quantity']
            remaining_demand_at_price = true_demand_at_price
            ...
            logger.debug("Average cost: {}".format(total_cost/(state['true_demand']+true_demand_at_price)))
